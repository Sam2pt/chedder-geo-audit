...
export async function notifyNewLead(lead: {
  ...
  const permalink = lead.sourceAuditSlug
    ...
    : null;
  const html = `
    <div style="font-family: -apple-system, BlinkMacSystemFont, 'Segoe UI', sans-serif; font-size: 14px; line-height: 1.6; color: #0f172a;">
...
export async function sendAuditPdf(input: {
  ...
  const html = `
    <div style="font-family: -apple-system, BlinkMacSystemFont, 'Segoe UI', sans-serif; font-size: 15px; line-height: 1.6; color: #0f172a; max-width: 520px; margin: 0 auto; padding: 24px;">
      ...
      <a href="${viewOnline}" style="display: inline-block; background: #0f172a; color: #fff; text-decoration: none; padding: 10px 18px; border-radius: 10px; font-weight: 600; font-size: 14px;">Re-run the audit</a>
...
export async function sendMagicLink(input: {
  ...
  const html = `
    <div style="font-family: -apple-system, BlinkMacSystemFont, 'Segoe UI', sans-serif; font-size: 15px; line-height: 1.6; color: #0f172a; max-width: 480px; margin: 0 auto; padding: 24px;">
      <div style="display: inline-block; background: linear-gradient(135deg, #d8a23e, #b58632); width: 48px; height: 48px; border-radius: 12px; margin-bottom: 20px;"></div>
      ...
      <a href="${input.link}" style="display: inline-block; background: #0f172a; color: #fff; text-decoration: none; padding: 12px 20px; border-radius: 12px; font-weight: 600; font-size: 14px;">Sign in to Chedder</a>
